...
def delete_env_vars
  ...
  ENV.delete("RWX")
  ENV.delete("RWX_GIT_COMMIT_SHA")
  ENV.delete("RWX_GIT_REF_NAME")
  ENV.delete("RWX_GIT_REPOSITORY_NAME")
  ENV.delete("RWX_RUN_ID")
  ENV.delete("RWX_RUN_URL")
  ENV.delete("RWX_TASK_ATTEMPT_NUMBER")
  ENV.delete("RWX_TASK_ID")
  ENV.delete("RWX_TASK_URL")
